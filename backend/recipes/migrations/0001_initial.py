# Generated by Django 2.2.19 on 2023-08-06 15:48
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(help_text='Введите ингредиент', max_length=200, verbose_name='Ингредиент')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('color', colorfield.fields.ColorField(default='#FFFFFF', help_text='Здесь цвет тега', image_field=None, max_length=7, samples=None, unique=True, verbose_name='Цвет тега')),
